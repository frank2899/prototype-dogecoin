function MenuDrawer () {
    return <>
        <aside className="kUhpTB VBlXw OffsetDrawer-sc-1y4meod-0 cwVxil"
        style={{transform:"translate3d(100%, 0, 0) translate3d(0px, 0, 0)"}}>
            <div height="100%" className="FlexColumnreact__FlexColumn-sc-1wwz3hp-0 cByXDs jYqxGr ksFzlZ">
                <div data-testid="NavMobile" width="[object Object]"
                    className="NavMobile__DivContainer-sc-1nkqeqe-0 biFbo jbfOAo">
                    <ul className="NavMobile--menu">
                        <div className="fresnel-container fresnel-lessThan-sm ">
                            <li className="NavMobile--solana-pill"></li>
                        </div>
                        <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls"><button
                            className="btgkrL NavItem--main NavItem--withIcon" type="button"><i
                                className="dVAufN NavItem--icon material-icons-outlined NavItem--icon" size="32"
                                value="explore">explore</i>Explore<i
                                className="dVAVbi NavMobile--submenu-icon material-icons NavMobile--submenu-icon" value="chevron_right"
                                size="24">chevron_right</i></button></li>

                        <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls"><button
                            className="btgkrL NavItem--main NavItem--withIcon" type="button"><i
                                className="dVAufN NavItem--icon material-icons-outlined NavItem--icon" size="32"
                                value="bar_chart">bar_chart</i>Stats<i
                                className="dVAVbi NavMobile--submenu-icon material-icons NavMobile--submenu-icon" value="chevron_right"
                                size="24">chevron_right</i></button></li>
                        ...
                        <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls"><button
                            className="btgkrL NavItem--main NavItem--withIcon" type="button"><i
                                className="dVAufN NavItem--icon material-icons-outlined NavItem--icon" size="32"
                                value="library_books">library_books</i>Resources<i
                                className="dVAVbi NavMobile--submenu-icon material-icons NavMobile--submenu-icon" value="chevron_right"
                                size="24">chevron_right</i></button></li>

                        <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls"><button
                            className="btgkrL NavItem--main NavItem--withIcon" type="button"><i
                                className="dVAufN NavItem--icon material-icons NavItem--icon" size="32" style={{transform:"rotate(45deg)"}}
                                value="mode_night">mode_night</i><span className="elqhCm jYqxGr NavMobile--toggle-container"><label
                                htmlFor="night-mode-toggle" className="Labelreact__StyledLabel-sc-5y2dd1-0 elqhCm kCOfJW TClWo">Night
                                mode</label><input type="checkbox" className="Togglereact__ToggleInput-sc-taymdu-0 ezUbmr"
                                role="switch" id="night-mode-toggle" /></span></button></li>
                                
                        <li width="100%" className="fskpjE jYqxGr"><button width="[object Object]" type="button"
                            className="YKFdh fzwDgL">Connect
                            wallet</button></li>
                    </ul>

                    <div height="80px" width="100%" className="gGngoX jYqxGr ksFzlZ iXcsEj cgnEmv">
                        <div height="30" className="navMenus__SocialsContainer-sc-1ccbejg-0 jfooZD jYqxGr cgVVjV">
                            <div className="elqhCm jYqxGr">
                                <a className="ekTmzq" href="https://twitter.com/opensea"
                                rel="nofollow noopener noreferrer" target="_blank" aria-label="Twitter Official">
                                    <div className="icons__DivContainer-sc-1dx2b3i-0 elqhCm jYqxGr dBmaRW">
                                        <svg className="Icon--withHoverChange" fill="#8A939B" style={{height:"20px",width:"30px"}}
                                            viewBox="0 0 18 16">
                                            <path
                            ...
                            <div className="elqhCm jYqxGr">
                                <a className="ekTmzq" href="https://www.instagram.com/opensea/"
                                rel="nofollow noopener noreferrer" target="_blank" aria-label="Instagram">
                                    <div className="icons__DivContainer-sc-1dx2b3i-0 elqhCm jYqxGr dBmaRW">
                                        <svg className="Icon--withHoverChange" fill="#8A939B" style={{height:"20px",width:"30px"}}
                                            viewBox="0 0 24 24">
                                            <path
                            ...
                            <div className="elqhCm jYqxGr">
                                <a className="ekTmzq" href="https://discord.gg/opensea"
                                rel="nofollow noopener noreferrer" target="_blank" aria-label="Discord">
                                    <div className="icons__DivContainer-sc-1dx2b3i-0 elqhCm jYqxGr dBmaRW">
                                        <svg className="Icon--withHoverChange" fill="#8A939B" style={{height:"20px",width:"30px"}}
                                            viewBox="0 0 22 16">
                                            <path
                            ...
                            <div className="elqhCm jYqxGr">
                                <a className="ekTmzq" href="https://reddit.com/r/opensea"
                                rel="nofollow noopener noreferrer" target="_blank" aria-label="Reddit">
                                    <div className="icons__DivContainer-sc-1dx2b3i-0 elqhCm jYqxGr dBmaRW">
                                        <svg className="Icon--withHoverChange" fill="#8A939B" style={{height:"20px",width:"30px"}}
                                            viewBox="0 0 24 24">
                                            <path
                            ...
                            <div className="elqhCm jYqxGr">
                                <a className="ekTmzq" href="https://www.youtube.com/c/OpenSeaTV"
                            ...
                            <div className="elqhCm jYqxGr">
                                <a className="ekTmzq" href="https://www.tiktok.com/@opensea?lang=en"
                                rel="nofollow noopener noreferrer" target="_blank" aria-label="TikTok">
                                    <div className="icons__DivContainer-sc-1dx2b3i-0 elqhCm jYqxGr dBmaRW">
                                        <svg className="Icon--withHoverChange" fill="#8A939B" style={{height:"20px",width:"30px"}}
        ...
        <div className="Overlayreact__Overlay-sc-1yn7g51-0 ftrwOt fresnel-greaterThanOrEqual-lg" aria-hidden="true"></div>
    </>
}
